...
public class MainFrm1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MainFrm1 frame = new MainFrm1(new User());
...
//				});
				...
				JScrollPane panel_11 = new JScrollPane();
				static_table = new JTable();
				static_table.setModel(new DefaultTableModel(
					new Object[][] {
					},
					new String[] {
						"\u771F\u5B9E\u6295\u6CE8", "New column", "New column", "New column", "New column", "New column", "New column", "New column", "New column"
					}
				));
				...
				panel_11.add(static_table);
				panel_11.setViewportView(static_table);
...
//				tabbedPane.addTab("New tab", null, static_table, null);
