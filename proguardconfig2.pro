...
-libraryjars 'J:\lottery\jar\jre\lib\jce.jar'
-libraryjars 'J:\lottery\jar\jre\lib\rt.jar'
...
-keep final class com.google.gson.** {
    <fields>;
    <methods>;
}

-keep public class com.jgoodies.** {
    <fields>;
    <methods>;
}
...
-keep public final class lombok.** {
    <fields>;
    <methods>;
}

-keep final class lombok.** {
    <fields>;
    <methods>;
}
